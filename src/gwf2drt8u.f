...
C  Deallocate DRT MEMORY
      ...
      INTEGER ALLOC_ERR
C
        DEALLOCATE(NDRTCL, STAT = ALLOC_ERR)
        DEALLOCATE(MXDRT, STAT = ALLOC_ERR)
        DEALLOCATE(NDRTVL, STAT = ALLOC_ERR)
        DEALLOCATE(NDRTNP, STAT = ALLOC_ERR)
        DEALLOCATE(IDRTCB, STAT = ALLOC_ERR)
        DEALLOCATE(NPDRT, STAT = ALLOC_ERR)
        DEALLOCATE(IDRTPB, STAT = ALLOC_ERR)
        DEALLOCATE(IDRTFL, STAT = ALLOC_ERR)
        DEALLOCATE(IDCHANGEC, STAT = ALLOC_ERR)
        DEALLOCATE(MXSPREADNDS, STAT = ALLOC_ERR)
        DEALLOCATE(IDCHNGTYP, STAT = ALLOC_ERR)
        DEALLOCATE(NODDRT, STAT = ALLOC_ERR)
        DEALLOCATE(DRTFLOW, STAT = ALLOC_ERR)
        DEALLOCATE(DRTAREA, STAT = ALLOC_ERR)
        DEALLOCATE(NRFLOW, STAT = ALLOC_ERR)
        DEALLOCATE(NOPRDT, STAT = ALLOC_ERR)
        DEALLOCATE(DRTF, STAT = ALLOC_ERR)
        DEALLOCATE(DRTAUX, STAT = ALLOC_ERR)
C
      RETURN
      END
