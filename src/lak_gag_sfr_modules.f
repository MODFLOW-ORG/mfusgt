...
crgn        REAL,   SAVE, DIMENSION(:),  POINTER ::EVAP,PRECIP,SEEP,SEEP3
        ...
        REAL,   SAVE, DIMENSION(:,:),POINTER ::CAUG,CPPT,CLAKINIT,CLKOLD
...
C
        INTEGER,SAVE,POINTER   :: ILKTRNSPT,IETLAK
        REAL,   SAVE, DIMENSION(:),  POINTER ::RMASLAK,VOUTLAK
        REAL,   SAVE, DIMENSION(:),  POINTER ::CGW2LAK,CUZF2LAK,
     1       CGWFROMLAK,CSFR2LAK,CSFRFROMLAK,CPRECLK,CRUNOFLK,CWDRLLK,
     1       CETLK,CSTORINLK,CSTOROTLK
