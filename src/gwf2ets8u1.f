...
C     ------------------------------------------------------------------
  500 FORMAT(1X,/
     ...
     &     ' 10/05/2015',/,9X,'INPUT READ FROM UNIT ',I5)
  510 FORMAT(
  ...
  542 FORMAT(1X,'ESFRACTION ARRAY FOR COMPONENTS 1 TO MCOMPT'/1X,44('-')
     &    /20F10.4)
...
C
        ...
        ELSE                  !READ ETFRACTOR ARRAY
          IF(IFREFM.EQ.0)THEN
            READ(IN,300) (ESFACTOR(I), I=1,MCOMPT)
300         FORMAT(20 F10.3)
          ELSE
            READ(IN,*) (ESFACTOR(I), I=1,MCOMPT)
          ENDIF
          WRITE(IOUT,542)(ESFACTOR(I), I=1,MCOMPT)
        ENDIF
      ENDIF
C
