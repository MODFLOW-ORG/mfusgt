...
C
      RETURN
      END
      SUBROUTINE ULASAV8(BUF,TEXT,KSTP,KPER,PERTIM,TOTIM,NCOL,
     1                   NROW,ILAY,ICHN)
C     ******************************************************************
...
C     ------------------------------------------------------------------
      CHARACTER*16 TEXT
      DOUBLE PRECISION PERTIM,TOTIM
      REAL*8 BUF(NCOL,NROW)
      REAL*8 PERTIMS,TOTIMS
C     ------------------------------------------------------------------
C
      PERTIMS = PERTIM
      TOTIMS = TOTIM
...
C3------RETURN
      RETURN
      END
      SUBROUTINE ULASAVRD8(BUF,TEXT,KSTP,KPER,PERTIM,TOTIM,NCOL,
     1                   NROW,ILAY,ICHN)
C     ******************************************************************
C     SAVE 1 LAYER ARRAY ON DISK
C     ******************************************************************
...
C     ------------------------------------------------------------------
      ...
      DOUBLE PRECISION PERTIM,TOTIM
      DOUBLE PRECISION BUF(NCOL,NROW)
      DOUBLE PRECISION PERTIMS,TOTIMS
C     ------------------------------------------------------------------
C1------WRITE AN UNFORMATTED RECORD CONTAINING IDENTIFYING
C1------INFORMATION.
      READ(ICHN) KSTP,KPER,PERTIMS,TOTIMS,TEXT,NCOLs,NROWs,ILAY
...
C      
C
      SUBROUTINE UBDSVBU(IBDCHN,NODES,NN,Q,VAL,NVL,NAUX,LAUX,IBOUND)
C     ******************************************************************
...
C1------WRITE CELL NUMBER AND FLOW RATE
      IF(NAUX.GT.0) THEN
         N2=LAUX+NAUX-1
         WRITE(IBDCHN) NN,Q,(VAL(N),N=LAUX,N2)
      ELSE
         WRITE(IBDCHN) NN,Q
      END IF
C
...
C5------RETURN
      RETURN
      END
      SUBROUTINE ULASAVU8(BUF,TEXT,KSTP,KPER,PERTIM,TOTIM,NSTRT,
...
C3------RETURN
     ...
     1                   NNDLAY,ILAY,ICHN,NODES)
C     ******************************************************************
C     READ SAVED 1 LAYER ARRAY ON DISK FOR UNSTRUCTURED FORMAT
C     ******************************************************************
C
C        SPECIFICATIONS:
C     ------------------------------------------------------------------
...
C3------RETURN
      RETURN
      END
      SUBROUTINE ULASAVURD8(BUF,TEXT,KSTP,KPER,PERTIM,TOTIM,NSTRT,
     1                   NNDLAY,ILAY,ICHN,NODES)
C     ******************************************************************
C     READ SAVED 1 LAYER ARRAY ON DISK FOR UNSTRUCTURED FORMAT
C     ******************************************************************
...
C5------RETURN
      ...
      END
C
      SUBROUTINE UBDSVHDRT(IUNSTR,KSTP,KPER,IOUT,IBNDCB,ICLNCB,NODES,
     1  NCLNNDS,NCOL,NROW,NLAY,NBND,NBNDVL,NAUX,IBOUND,
...
C5------RETURN
      ...
      END
C
      SUBROUTINE UBDSVHDRQRT(IUNSTR,KSTP,KPER,IOUT,IBNDCB,ICLNCB,NODES,
     1  NCLNNDS,NCOL,NROW,NLAY,NBND,NBNDVL,NAUX,IBOUND,
